...
def main():
    ...
    for time_step in np.arange(start=0, stop=total_time, step=delta_t):
        ...
        # Intro_march
        # Strut formation ("Bad bitches to the left...")
        # Hovering on default
        # Circles "It costs a billion to look this good"
    ...
    animation = plot.DroneAnimation(drone_step_sequence, interval=50)  # 20 ms between frames
    animation.animate()
